...
// GET /api/quiz/typescript             → random question (no answer)
// GET /api/quiz/typescript?all=true    → all questions (no answers)
// GET /api/quiz/typescript/:id/answer  → answer for a specific question
